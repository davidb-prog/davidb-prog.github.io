...
// build-og, build-marque, build-captures) : trouver Chromium, et lire / rogner /
// rééchantillonner / écrire un PNG à la main. Zéro dépendance : seul zlib,
// intégré à Node, est utilisé.
//
